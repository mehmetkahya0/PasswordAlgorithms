...
def password_generator():
    ...
    back_button = Button(root, text="<", font=("Helvetica", 15), bg="#186894", fg="red", command=back_to_black)
    ...
    header = Label(root, text="Password Generator", font=("Helvetica", 30, "bold"), bg="#186894", fg="white", cursor="heart")
    header.place(x=90, y=20)
    
    length = Label(root, text="Set the length of the password: ", font=("Helvetica", 15), bg="#186894", fg="white")
    length.place(x=10, y=100)

    length_entry = Entry(root, width=25, borderwidth=2)
    length_entry.place(x=235, y=100)

    alternative = Label(root, text="How many passwords to generate: ", font=("Helvetica", 13), bg="#186894", fg="white")
    alternative.place(x=10, y=150)

    alternative_entry = Entry(root, width=25, borderwidth=2)
    alternative_entry.place(x=235, y=150)

    specialCharacters = Label(root, text="Do you want special characters in your password?", font=("Helvetica", 13), bg="#186894", fg="white")
    ...
    password_label = Label(root, text="", font=("Helvetica", 13), bg="#186894", fg="white")
    ...
    generate_button = Button(root, text="Generate", font=("Helvetica", 15, "bold"), bg="#186894", fg="red", command=generate)
    generate_button.place(x=10, y=250)

def password_checker():
    back_button = Button(root, text="<", font=("Helvetica", 15), bg="#186894", fg="red", command=back_to_black, width=2)
    back_button.place(x=10, y=27)
    ...
    header = Label(root, text="Password Checker", font=("Helvetica", 30, "bold"), bg="#186894", fg="white")
    header.place(x=90, y=20)


    password_label = Label(root, text="Enter your password: ", font=("Helvetica", 20), bg="#186894", fg="white")
    password_label.place(x=10, y=100)

    password_entry = Entry(root, width=30, borderwidth=2)
    password_entry.place(x=215, y=100)

    result_label = Label(root, text="", font=("Helvetica", 13), bg="#186894", fg="white")
    ...
    check_button = Button(root, text="Check", font=("Helvetica", 15), bg="#186894", fg="black", command=check_password, width=30)
    check_button.place(x=100, y=150)


def mainScreen():
    global password_generator_button, password_checker_button, ascii_art, Mainheader
    Mainheader = Label(root, text="Password Algorithms", font=("Helvetica", 30, "bold"), bg="#186894", fg="white")
    Mainheader.place(x=90, y=20)

    password_generator_button = Button(root, text="Password Generator", font=("Helvetica", 15, "bold"), bg="#186894", fg="black", command=password_generator, width=20, height=10)
    password_generator_button.place(x=20, y=100)

    password_checker_button = Button(root, text="Password Checker", font=("Helvetica", 15, "bold"),  bg='#186894',fg='black',command=password_checker, width=20, height=10)
    ...
    ██║     ██║  ██║███████║███████║    
    ╚═╝     ╚═╝  ╚═╝╚══════╝╚══════╝  
''', font=("Helvatica", 10), bg="#186894", fg="white", cursor="heart red", justify="center", anchor="w")
    ascii_art.place(x=75, y=300)


    acopyright = Label(root, text="© 2023 - Password Algorithms - Mehmet Kahya", font=("Helvetica", 12, "bold"), bg="#186894", fg="white")
    ...
    credit = Button(root, text="Credits", font=("Helvetica", 10, "bold"), bg="#186894", fg="black", command=credits)
